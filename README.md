...
Buzz calls `:state` twice for one page: once to render the first paint, and again when the browser opens its event stream. Read the request rather than act on it.
